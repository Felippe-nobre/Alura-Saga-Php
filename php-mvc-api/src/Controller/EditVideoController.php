    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($uploadedImage->getError() === UPLOAD_ERR_OK) {
            ...
            if (str_starts_with($mimeType, 'image/')) {
                $safeFileName = uniqid('upload_') . '_' . pathinfo($uploadedImage->getClientFilename(), PATHINFO_BASENAME);// esse uniqid cria um identificador unico, aqui ele cria um identificador unico para o upload
